...
subtitle: "Fermat's Christmas Theorem series"
date: "2025-12-08"
categories: [Expository, Number Theory]

series: "Fermat's Christmas Theorem"
---
...
But we said that any integer number can be written as the product of primes. However, since $m$ is not divisible by any prime in the list $p_1,\dots,p_n$, it means that the list does not contain all of the primes.
...
Previous: [Introduction](https://sheafofthoughts.org/posts/fermat-christmas-theorem/introduction/introduction.html)
<!-- Next: [Title of part 3](/posts/fermat-christmas-theorem/part-3/) -->
:::
