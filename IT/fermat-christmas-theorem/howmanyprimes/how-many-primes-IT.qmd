...
Ma abbiamo detto che ogni numero intero può essere scritto come prodotto di numeri primi. Tuttavia, poiché $m$ non è divisibile da nessuno dei primi nella lista $p_1,\dots,p_n$, significa che la lista non contiene tutti i numeri primi.
